              ...
              <div className="flex h-16 items-center">
                ...
                <div className="ml-auto flex items-center">
                  <div className="space-x-2 lg:space-x-6 flex flex-1 items-center justify-end">
                    ...
                    <NavLink to={'/contact'}
                             className={({isActive}) => isActive ? "underline text-xs lg:text-sm font-medium text-gray-700 hover:text-gray-800" : "text-xs lg:text-sm font-medium text-gray-700 hover:text-gray-800"}>Contact
                      Us</NavLink>
                  </div>
                  {/*Cart*/}
